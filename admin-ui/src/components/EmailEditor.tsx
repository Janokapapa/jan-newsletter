...
export default function EmailEditor({ content, onChange, disabled }: EmailEditorProps) {
  ...
  const initTinyMCE = useCallback(() => {
    ...
    window.tinymce.init({
      ...
      height: 500,
      menubar: true,
      plugins: 'lists link image charmap fullscreen media paste textcolor colorpicker wordpress wplink',
      ...
      toolbar2: 'bullist numlist outdent indent | link image media | charmap | removeformat | fullscreen',
      toolbar_mode: 'wrap',
      branding: false,
      promotion: false,
      convert_urls: false,
